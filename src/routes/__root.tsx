...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Resize, crop, rotate and convert images to JPG, PNG, WEBP, AVIF, GIF, BMP or TIFF — privately in your browser." },
      { name: "author", content: "SPD Produktion" },
      { property: "og:title", content: "Image size & format converter" },
      { property: "og:description", content: "Resize, crop, rotate and convert images to JPG, PNG, WEBP, AVIF, GIF, BMP or TIFF — privately in your browser." },
